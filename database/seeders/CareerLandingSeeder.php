    ...
    public function run(): void
    {
        $sections = [
            [
                ...
                'subtitle' => 'در {company}، فروش، تکنولوژی، لجستیک، محتوا و پشتیبانی کنار هم کار می‌کنند تا تجربه خرید قطعات سریع‌تر، دقیق‌تر و قابل‌اعتمادتر شود.',
                'payload' => [
                    'badge' => 'جای تو در تیم {company} خالیه',
                ],
                'sort_order' => 5,
            ],
            [
