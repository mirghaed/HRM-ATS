...
class HrmSettingSeeder extends Seeder
{
    public function run(): void
    {
        $settings = [
            ...
            ['key' => 'landing.hero_badge', 'value' => 'جای تو در تیم {company} خالیه', 'group' => 'landing', 'type' => 'string'],
            ['key' => 'landing.hero_title', 'value' => 'به تیم‌هایی بپیوند که رشد را واقعی می‌سازند', 'group' => 'landing', 'type' => 'string'],
            ['key' => 'landing.hero_subtitle', 'value' => 'در {company} روی پروژه‌های واقعی کار می‌کنیم، مسئولیت می‌گیریم و با داده تصمیم می‌گیریم.', 'group' => 'landing', 'type' => 'string'],
            ['key' => 'landing.header_brand_text', 'value' => 'فرصت‌های همکاری {company}', 'group' => 'landing', 'type' => 'string'],
            ['key' => 'landing.departments_kicker', 'value' => 'تیم‌ها و دپارتمان‌ها', 'group' => 'landing', 'type' => 'string'],
            ['key' => 'landing.departments_title', 'value' => 'تیم‌هایی که در {company} کنار هم کار می‌کنند', 'group' => 'landing', 'type' => 'string'],
            ['key' => 'landing.why_kicker', 'value' => 'چرا همکاری با ما', 'group' => 'landing', 'type' => 'string'],
            ['key' => 'landing.why_title', 'value' => 'چرا {company}؟', 'group' => 'landing', 'type' => 'string'],
            ['key' => 'landing.culture_kicker', 'value' => 'ترکیب نظم عملیاتی و سرعت اجرای تکنولوژی', 'group' => 'landing', 'type' => 'string'],
            ['key' => 'landing.culture_title', 'value' => 'فرهنگ همکاری در {company}', 'group' => 'landing', 'type' => 'string'],
            ['key' => 'landing.culture_content', 'value' => 'در {company} شفافیت، مسئولیت‌پذیری و کار تیمی پایه‌های اصلی همکاری هستند. هر نقش مالک خروجی خود است و با هماهنگی بین تیم‌ها، نتیجه‌ای بهتر برای مشتری ساخته می‌شود.', 'group' => 'landing', 'type' => 'string'],
            ['key' => 'landing.logo_url', 'value' => '/assets/brand/yadak-shop-logo.svg', 'group' => 'landing', 'type' => 'string'],
            ['key' => 'landing.logo_url_dark', 'value' => '', 'group' => 'landing', 'type' => 'string'],
            ...
            ['key' => 'landing.gallery_title', 'value' => 'تصویر زندگی کاری در {company}', 'group' => 'landing', 'type' => 'string'],
